...
export const HomeAction = (type, tag, offest, limit, isRefreshing, isLoading) => {
...
const feachHomeList = (isRefreshing, isLoading) => {
    return {
...
const receiveHomeList = (homeList) => {
...
const feachSeaUGoList = (isRefreshing, isLoading) => {
    return {
...
const receiveSeaUGoList = (uGoList) => {
    // console.log(homeList)
    return {
